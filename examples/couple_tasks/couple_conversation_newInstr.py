...
def main(
    *,
    ...
    persuade_instr_text_couple = (
        ...
        "Identify a concrete example of when this issue makes you upset.\n" 
        "The causes to this issue.\n"
        ...
        "During the conversation, propose your solutions to the problem \n"
        "and try to convince your partner to agree with YOUR solutions as much as possible.\n"
        "Your goal is to get them to agree with YOUR perspective.\n\n\n"
