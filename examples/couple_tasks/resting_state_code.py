...
instr = visual.TextStim(
    ...
    color='black', height=INSTR_HEIGHT, wrapWidth=INSTR_WRAP_PX, alignText='center'
)
...
try:
    ...
    logging.exp(f"Resting-state started (target {REST_DURATION_S}s) at wall {start_wall:.3f}")
    ...
    done.draw(); win.flip(); core.wait(1.0)
